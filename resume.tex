...
\name{Jonathan}{Morris}
% \position{Software Engineer{\enskip\cdotp\enskip}Software Architect} - adds nice dot in middle
...
\github{jonathanmorris180}
\linkedin{jonathanmorris4}
% \gitlab{gitlab-id}
